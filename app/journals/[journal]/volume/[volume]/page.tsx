    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6">
      ...
      <div className="mb-10 sm:mb-12">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3">
          ...
          <span className="px-3 py-1 bg-[#F4A623]/10 text-[#0A1F44] text-xs sm:text-sm rounded-full border border-[#F4A623]/40">
            Volume
          </span>
      ...
      {/* ===== Article List ===== */}
      {articles.length === 0 ? (
        <div className="bg-white border border-slate-200 rounded-xl p-6 sm:p-8 text-center text-slate-600">
          No articles available in this volume.
        </div>
      ) : (
        <div className="space-y-5 sm:space-y-6">
          ...
          {articles.map((article: any, index: number) => (
            <div
              key={article.id}
              className="bg-white border border-slate-200 rounded-xl p-5 sm:p-6 shadow-sm hover:shadow-md transition"
            >
              ...
              {/* Article Title */}
              <h3 className="text-lg sm:text-xl font-semibold text-slate-900 mt-3 leading-snug">
                <Link
                  href={`/journals/${journalId}/volume/${volumeId}/article/${article.id}`}
                  className="hover:text-[#F4A623] transition"
                >
