    ...
    <div className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-center">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          ...
          <div className="relative w-20 h-20 rounded-[1.8rem] bg-white border border-slate-200 shadow-xl flex items-center justify-center">
        ...
        <div>
          ...
          <h1 className="text-4xl sm:text-5xl font-black tracking-tight bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-700 bg-clip-text text-transparent">

            DRL JOURNALS

          </h1>

          <p className="mt-1 text-sm tracking-[0.35em] uppercase text-slate-500 font-medium">
  ...
  <div className="relative max-w-7xl mx-auto px-6 pt-24 pb-24">
    ...
    <div className="grid lg:grid-cols-2 gap-20 items-center">
      ...
      <div>
        ...
        {/* BADGE */}
<div className="inline-flex items-center gap-3 px-5 py-2 rounded-full border border-blue-200 bg-blue-50 text-blue-800 text-sm font-semibold shadow-sm">
...
{/* HEADING */}
<h2 className="mt-10 text-6xl sm:text-7xl xl:text-[6.8rem] font-black leading-[0.92] tracking-tight">
...
{/* DESCRIPTION */}
<p className="mt-10 text-xl leading-relaxed text-slate-600 max-w-2xl">
  ...
  global research accessibility.
        ...
        <div className="mt-14 flex flex-wrap gap-5">
          ...
          <Link
            href="#journals"
            className="px-10 py-5 rounded-2xl bg-slate-900 text-white text-lg font-semibold shadow-2xl hover:scale-[1.03] hover:bg-slate-800 transition-all duration-300"
          >
            Explore Journals
          </Link>
          ...
          <Link
            ...
            className="px-10 py-5 rounded-2xl border border-slate-300 bg-white text-slate-900 text-lg font-semibold hover:bg-slate-50 hover:shadow-xl transition-all duration-300"
          >
            Submit Manuscript
          </Link>
        ...
        {/* STATS */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-5 mt-20">
          ...
          {[
            ...
            <div
              key={item.label}
              className="rounded-[28px] border border-white/60 bg-white/80 backdrop-blur-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300"
            >
      ...
      <div className="relative">
        ...
        {/* MAIN GLASS CARD */}
        <div className="relative rounded-[40px] border border-white/60 bg-white/70 backdrop-blur-2xl overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.08)]">
          ...
          <div className="p-8 border-b border-slate-200 flex items-center justify-between">
            ...
            <div>
              ...
              <p className="uppercase tracking-[0.3em] text-xs font-bold text-blue-700">
...
<div className="rounded-[32px] bg-gradient-to-br from-blue-700 to-indigo-800 p-10 text-white shadow-2xl">

  <p className="uppercase tracking-[0.3em] text-xs font-bold text-blue-100">
    Academic Excellence
  </p>
    ...
    standards, and global dissemination of scientific knowledge.
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              {[
                ...
                <div
                  key={item.title}
                  className="rounded-2xl border border-slate-200 bg-white p-6 hover:shadow-xl transition-all duration-300"
                >
      ...
      <section
        id="journals"
        className="relative py-24 bg-slate-50/60 border-t border-slate-200"
      >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            {/* <p className="uppercase tracking-[0.25em] text-sm font-semibold text-blue-700">
              Academic Publications
            </p> */}

            <h2 className="mt-4 text-4xl sm:text-5xl font-black text-slate-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {journals.map((journal: any) => (
              ...
              >
                ...
                <div className="h-full rounded-[32px] border border-slate-200 bg-white shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden">
                  ...
                  <div className="p-8 sm:p-10">
                    ...
                    <div className="flex items-center justify-between mb-8">
                      ...
                      <span className="px-4 py-2 rounded-full bg-blue-50 text-blue-900 text-xs font-semibold border border-blue-100">
                        Peer Reviewed
                      </span>
                    ...
                    {/* TITLE */}
                    <h3 className="text-3xl font-black text-slate-900 leading-snug group-hover:text-blue-900 transition">
                    ...
                    <div className="mt-10">
                      ...
                      <Link
                        href={`/journals/${journal.id}`}
                        className="inline-flex items-center gap-3 px-7 py-4 rounded-2xl bg-blue-900 text-white font-semibold hover:bg-blue-800 transition shadow-lg"
                      >
                        Explore Journal
                        <span>→</span>
                      </Link>
